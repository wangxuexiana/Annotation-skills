...
9. After filling a task, close newly opened model product preview pages and keep only the original annotation page for user review, unless the user explicitly asks to keep previews open.
